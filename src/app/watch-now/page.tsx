...
export default function WatchNow() {
  ...
  const playerOptions = [
    ...
    { label: "Secondary",  value: "embed.7xstream.tv"},
  ...
  useEffect(() => {
    const initializeValues = async () => {
      ...
      if (userId && (["videasy.net", "embed.7xstream.tv", "vsembed.ru"].includes(selectedPlayer))) {
        try {
  ...
  useEffect(() => {
    ...
    if (seasonId && episodeId && selectedPlayer !== "vidplus.to") {
      if (!selectedEpisode && !selectedSeason) {
        setSelectedSeason(1);
  ...
  useEffect(() => {
    const handleMessage = (event: any) => {
      ...
      if (event.origin !== "https://vidplus.to") return;
  ...
  useEffect(() => {
    ...
    const onWindowBlur = () => {
      if (iframeMouseOver) {
        ...
        if ((["videasy.net", "embed.7xstream.tv", "vsembed.ru"].includes(selectedPlayer)) && userId && movieId && mediaType) {
          const payload = {
                    ...
                    <section>
                      <div className="w-full flex flex-col lg:flex-row gap-5 justify-between flex-wrap lg:flex-nowrap">
                        ...
                        <section className="relative text-white hover:!text-amber-500  flex items-end justify-end gap-1">
                          ...
                          >
                            <IoIosAddCircleOutline className="w-7 h-7 text-inherit" /> My List
                          </div>
                        </section>
                      </div>
                      <div className="w-full">
                          ...
                          <>
                            <Dropdown
                              ...
                              onChange={(e: DropdownChangeEvent) => {
                                ...
                                if (([ "videasy.net", "embed.7xstream.tv","vsembed.ru"].includes(selectedPlayer))) {
