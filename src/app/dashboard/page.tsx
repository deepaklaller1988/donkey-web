                ...
                <div className="enterHomeInner bg-zinc-900 rounded-[30px]">
                    <div className="w-full p-4 md:p-10">
                        <div className="enterHeader">
                            <a href="" className="w-[120px] md:w-[180px] block m-auto">
                                <Image width={1000}
                                    height={1000}
                                    quality={100}
                                    priority={true}
