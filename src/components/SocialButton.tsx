        ...
        <div className="share-container max-w-screen-lg mx-auto">
            <div className="flex justify-center gap-2 md:gap-4 mt-4">
                ...
                <FacebookShareButton url={`${process.env.NEXT_PUBLIC_API_URL}`}>
                    <div className="bg-zinc-500/20 rounded-md p-2 md:px-4 py-2 flex items-center justify-center text-white">
                        <FaFacebook className="w-5 h-5 text-sky-600"/>
                        <span className="hidden md:block ml-2 text-[15px]">11.4k</span>
                    </div>
                </FacebookShareButton>
                ...
                <TwitterShareButton url={`${process.env.NEXT_PUBLIC_API_URL}`}>
                    ...
                    <PiXLogoBold className="w-5 h-5 text-sky-500" />
                        <span className="hidden md:block ml-2 text-[15px]">7.4k</span>
                    </div>
                </TwitterShareButton>
               ...
               <FacebookMessengerShareButton url={`${process.env.NEXT_PUBLIC_API_URL}`} appId="">
                <div className="bg-zinc-500/20 rounded-md p-2 md:px-4 py-2 flex items-center justify-center text-white">
                    ...
                    <span className="hidden md:block ml-2 text-[15px]">2k</span>
                </div>
                </FacebookMessengerShareButton> 
                ...
                <RedditShareButton url={`${process.env.NEXT_PUBLIC_API_URL}`}>
                    <div className=" bg-zinc-500/20 rounded-md p-2 md:px-4 py-2 flex items-center justify-center text-white">
                        ...
                        <span className="hidden md:block ml-2 text-[15px]">116k</span>
                    </div>
                </RedditShareButton>
                ...
                <div className="bg-zinc-500/20 rounded-md p-2 md:px-4 py-2 flex items-center justify-center text-white">
                    ...
                    <span className="hidden md:block ml-2 text-[15px]">1.8k</span>
                </div>
                </WhatsappShareButton>
                ...
                <div className="bg-zinc-500/20 rounded-md p-2 md:px-4 py-2 flex items-center justify-center text-white">
                    ...
                    <span className="hidden md:block ml-2 text-[15px]">345k</span>
                </div>
                </TelegramShareButton>
            </div>
        </div>
