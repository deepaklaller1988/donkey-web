                    ...
                    <div className='sliderContentSet pl-0 md:pl-4'>
                      ...
                      <section className='flex mt-4 gap-4'>
                        ...
                        <div className="relative flex gap-4" onMouseLeave={() => setIsOpen(false)}>
                          <button className='flex items-center gap-2 transition text-white hover:text-amber-500 px-6 py-2 font-semibold'
                            onClick={() => {
                              handleWatchPopup();
                              handleBookmark(item.id, item.media_type, 'planning-to-watch');
                            }}><FaPlus className='w-5 h-5' /> My List</button>
